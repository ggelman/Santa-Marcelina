    ...
    def generate(self, prompt: str, options: Optional[Dict[str, Any]] = None) -> ProviderResponse:
        ...
        for provider in self.providers:
            ...
            try:
                ...
                logger.warning("Resposta inválida do provedor %s", provider.name)
        ...
        return ProviderResponse(ok=False, content="Nenhuma resposta disponível", provider="none", metadata={"attempts": attempts})
