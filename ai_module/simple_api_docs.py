#!/usr/bin/env python3
"""
Documentação API HTML Simples
=============================

Documentação interativa das APIs usando HTML puro.
"""
...
def create_docs_app():
    """Cria aplicação Flask com documentação HTML."""
    app = Flask(__name__)
    CORS(app)
...
<body>
    <div class="container">
        <div class="header">
            <h1>🍞 Sistema AI da Padaria</h1>
            <p>Documentação Completa das APIs - Versão 1.0.0</p>
        ...
        <div id="overview" class="section active">
            <h2>📋 Visão Geral</h2>
            <p>Sistema de IA completo para predição de demanda e análise de dados de vendas.</p>
            
            <div class="feature-grid">
                <div class="feature-card">
                    <h3>🧠 Inteligência Artificial</h3>
                    <ul>
                        <li>Predição com Prophet</li>
                ...
                <div class="feature-card">
                    <h3>🗄️ Cache Inteligente</h3>
                    <ul>
                        <li>Redis com fallback</li>
                        <li>TTL configurável</li>
                        <li>Hit rate > 80%</li>
        ...
        <div id="ai" class="section">
            <h2>🧠 APIs de Inteligência Artificial</h2>
            
            <div class="endpoint">
                <div class="endpoint-header" onclick="toggleDetails('predict-details')">
                    <span class="method post">POST</span>
                    <strong>/api/ai/predict</strong> - Predição de demanda
                </div>
  ...
  "cache_hit": false
            ...
            <div class="endpoint">
                <div class="endpoint-header" onclick="toggleDetails('insight-details')">
                    <span class="method post">POST</span>
                    <strong>/api/ai/generate-insight</strong> - Geração de insights
                </div>
                <div id="insight-details" class="endpoint-details">
                    <h4>Descrição</h4>
                    <p>Gera insights estratégicos usando IA (Gemini/OpenAI).</p>
                    
                    <h4>Parâmetros</h4>
                    <div class="code">
{
  "prompt": "Analise vendas de bolo dos últimos 7 dias",
  "context_data": {...},
  "max_tokens": 500,
  "model": "gemini"
}</div>
                    ...
                    <ul>
                        <li>"Analise padrão de vendas nos finais de semana"</li>
                        <li>"Sugira estratégias para aumentar vendas de café"</li>
        ...
        <div id="health" class="section">
            ...
            <div class="endpoint">
                ...
                <div id="health-robust-details" class="endpoint-details">
                    ...
                    <ul>
                        <li><strong>Database (MySQL)</strong> - Conectividade, latência</li>
                        ...
                        <li><strong>Sistema</strong> - CPU, memória, disco</li>
                    </ul>
  ...
  "alerts": ["WARNING: Redis - Performance degraded"]
            ...
            <div class="endpoint">
                <div class="endpoint-header" onclick="toggleDetails('health-summary-details')">
                    <span class="method get">GET</span>
                    <strong>/api/health/summary</strong> - Resumo de saúde
                </div>
                <div id="health-summary-details" class="endpoint-details">
                    <p>Resumo rápido ideal para checks frequentes e dashboards.</p>
                </div>
            </div>
        </div>
        ...
        <div id="test" class="section">
            ...
            <div class="test-form">
                ...
                <button class="btn" onclick="testPrediction()">🔮 Testar Predição</button>
    ...
    <script>
        ...
        async function testPrediction() {
            ...
            resultDiv.innerHTML = '<p>🔄 Executando predição...</p>';
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    resultDiv.innerHTML = `
                        <h4>✅ Predição Realizada</h4>
                        <p><strong>Produto:</strong> ${result.product_name}</p>
                        <p><strong>Predições:</strong> ${result.prediction?.slice(0,3).join(', ')}...</p>
                        <details>
                ...
                resultDiv.innerHTML = `
                    ...
                    <p>Verifique se a API está rodando em http://localhost:5001</p>
        ...
        async function testHealth() {
            ...
            try {
                ...
                if (response.ok) {
                    resultDiv.className = 'response success';
                    resultDiv.innerHTML = `
                        <h4>✅ Health Check Concluído</h4>
                        <p><strong>Status:</strong> ${result.overall_status}</p>
                        <p><strong>Componentes:</strong> ${result.summary?.healthy_components || 0}/${result.summary?.total_components || 0} saudáveis</p>
                        <details>
...
if __name__ == '__main__':
    ...
    print("🚀 Documentação API Ativa!")
    print("=" * 50)
    print("📖 Documentação: http://localhost:5002")
