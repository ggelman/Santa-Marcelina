...
def retrain_prophet_models(original_data_path, models_dir, new_data_path=None):
    """Retreina modelos Prophet com dados atualizados e parâmetros otimizados."""
    # Carrega os dados históricos originais
    ...
    if df.empty:
        print("DataFrame vazio após concatenação. Não é possível retreinar modelos.")
        return
    ...
    for product_name in unique_products:
        ...
        if os.path.exists(params_filename):
            ...
            # Usar parâmetros padrão se não houver otimizados
            optimized_params = {
        ...
        # Inicializa e treina o modelo Prophet com parâmetros otimizados
        model = Prophet(
        ...
        # Adicionar regressores extras (variáveis externas)
